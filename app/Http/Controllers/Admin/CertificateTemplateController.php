...
class CertificateTemplateController extends Controller
{
	...
	{
		// LANGKAH 1: Lepaskan relasi dengan Event terlebih dahulu.
		// Cari semua event yang menggunakan template ini, lalu set kolom certificate_template_id menjadi NULL.
		// Ini memastikan Event tidak ikut terhapus, hanya hubungannya saja yang putus.
		Event::where('certificate_template_id', $certificateTemplate->id)
			->update(['certificate_template_id' => null]);

		// LANGKAH 2: Hapus semua gambar terkait (Kode lama Anda)
