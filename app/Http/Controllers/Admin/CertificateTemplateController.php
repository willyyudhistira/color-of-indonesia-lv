...
class CertificateTemplateController extends Controller
{
    ...
    public function destroy(CertificateTemplate $certificateTemplate)
    {
        ...
        $imageFields = ['background_image', 'logo1', 'logo2', 'logo3', 'logo4', 'logo5', 'logo6', 'logo7', 'center_logo', 'signature1_image', 'signature2_image'];
    ...
    public function updateTemplateData(Request $request, CertificateTemplate $template)
    {
        ...
        $textFields = ['signature1_name', 'signature1_title', 'signature2_name', 'signature2_title'];
    ...
    {
        // Dummy event agar sesuai dengan template
        $dummyEvent = new Event([
            'title' => 'Event Name (Example)',
            'start_date' => now(),
        ]);
        ...
        // Dummy participant, attach event
        $dummyParticipant = new Participant([
            'name' => 'Participant Name (Example)',
            'group' => 'Group / Institution (Example)',
            'category' => 'Winner (Example)',
        ...
        // Render PDF menggunakan view 'certificate.template' yang benar
        $pdf = Pdf::loadView('certificate.template', [
            'participant' => $dummyParticipant,
            'is_preview' => false // Penting: ini akan memicu public_path() untuk gambar
