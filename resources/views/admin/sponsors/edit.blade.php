    ...
    <div class="bg-white p-8 rounded-lg shadow-md max-w-3xl mx-auto">
        ...
        <form action="{{ route('admin.sponsors.update', $sponsor) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                {{-- PASTIKAN ID UNIK --}}
                <input id="edit_logo_url_input" type="file" name="logo_url" accept="image/*" class="mt-2 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0">
                <p class="text-xs text-gray-500 mt-1">Upload gambar baru untuk mengganti logo.</p>
            </div>
            
            <div class="flex justify-end gap-4 pt-4 border-t mt-6">
                <a href="{{ route('admin.sponsors.index') }}" class="py-2 px-6 bg-gray-200 rounded-lg">Batal</a>
