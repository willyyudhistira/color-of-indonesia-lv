...
@section('content')
    <div class="bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Tambah Peserta Manual</h2>
        ...
        <form action="{{ route('admin.participants.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-end gap-4 pt-4 border-t mt-6">
                <a href="{{ route('admin.participants.index') }}" class="py-2 px-6 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">Batal</a>
