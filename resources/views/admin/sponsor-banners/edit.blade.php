...
@section('content')
    <div class="bg-white p-8 rounded-lg shadow-md max-w-3xl mx-auto">
        ...
        <form action="{{ route('admin.sponsor-banners.update', $sponsorBanner) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                <label for="name" class="block text-sm font-medium">Nama Banner</label>
            ...
            <div>
                <label for="link_url" class="block text-sm font-medium">Link Banner (URL)</label>
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Upload gambar baru untuk mengganti banner.</p>
            </div>
