...
<div>
    <label for="embed_code" class="block text-sm font-medium text-gray-700">YouTube Embed Code</label>
    <textarea id="embed_code" name="embed_code" rows="5" required
              ...
              placeholder='Example: <iframe width="560" height="315" src="..." ...></iframe>'>{{ old('embed_code', $video->embed_code ?? '') }}</textarea>
    <p class="text-xs text-gray-500 mt-1">Copy the embed code directly from the YouTube video page.</p>
</div>

<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div>
        <label for="sort_order" class="block text-sm font-medium text-gray-700">Content Order</label>
    ...
    <div class="flex items-end">
        <div class="flex items-center gap-3">
            ...
            <label for="is_published" class="text-sm font-medium text-gray-700">Publish Videos</label>
        </div>
    </div>
</div>
