...
@section('content')
    ...
    <section class="relative h-96 flex items-center justify-center text-white">
        ...
        <div class="relative z-10 text-center px-4">
            <h1 class="text-4xl md:text-6xl font-extrabold font-serif">Verifikasi E-Sertifikat</h1>
            <p class="mt-4 text-lg md:text-xl max-w-2xl mx-auto">Masukkan nomor unik Anda untuk mengunduh sertifikat partisipasi.</p>
        </div>
    </section>
    ...
    <section class="py-20">
        <div class="container mx-auto px-6 text-center">
            ...
            <form action="{{ route('e-certificate.generate') }}" method="POST" class="max-w-md mx-auto">
                @csrf
                <label for="certificate_number" class="block text-lg font-semibold text-gray-700 mb-2">Masukkan Nomor Sertifikat Anda</label>
