<footer class="px-20 relative bg-gradient-to-r from-[#2546bd] via-[#A200FF] to-pink-400 text-white overflow-hidden">
    ...
    <div class="absolute inset-0 z-0 flex justify-end">
        <img src="{{ asset('assets/images/patternfooter2.png') }}" class="h-full w-1/2 object-cover opacity-40"
            alt="Batik Pattern">
    </div>
    ...
    <div class="relative container mx-auto px-8 pt-16 z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-12">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="flex items-start space-x-2">
                    ...
                    <p class="text-sm">Graha Fadillah, Jl. Raya BSD Bintaro 5, Paringi, Pondok Aren, Tangerang Selatan
                    </p>
                </div>
            </div>
            ...
            <div class="lg:col-span-3">
                ...
                <div class="flex items-center mb-6">
                    <input type="email" placeholder="Your Email"
                        class="w-full px-4 py-2 text-gray-800 rounded-l-full border-1 border-purple-500 focus:ring-2 focus:ring-purple-500 focus:outline-none">
                    <button type="submit"
                        class="bg-white text-purple-700 font-bold px-4 py-2 rounded-r-full hover:bg-purple-700 hover:text-white transition-colors">Subscribe</button>
                </div>
        ...
        <div class="flex justify-center mt-8">
            <a href="https://info.flagcounter.com/ozc6"><img
                    src="https://s05.flagcounter.com/count2/ozc6/bg_FFFFFF/txt_000000/border_CCCCCC/columns_3/maxflags_12/viewers_0/labels_1/pageviews_0/flags_0/percent_1/"
                    alt="Flag Counter" border="0"></a>
        </div>
        <div class="border-t border-white mt-12 py-6 pt-6 text-center text-sm text-gray-200">
